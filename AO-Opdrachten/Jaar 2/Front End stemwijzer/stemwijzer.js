...
// var kpartij = document.getElementById("kpartij");
...
var btnResultaat =  document.getElementById("resultaat");
...
btnMening.onclick = function(){
  antwoorden[questions] = "geen mening";
  geenMening++
   console.log(antwoorden);
   }
    
   btnContra.onclick = function(){
  antwoorden[questions] = "contra";
  contra++
  console.log(antwoorden);
  }
...
buttons.onclick = function(){
  if( questions === subjects.length -1){
    ...
    btnResultaat.style.display = 'inline-block'; 
  }else{
    questions++
